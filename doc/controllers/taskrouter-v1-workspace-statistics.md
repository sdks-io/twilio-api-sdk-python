...
```python
taskrouter_v_1_workspace_statistics_api = client.taskrouter_v_1_workspace_statistics
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`WorkspaceStatistics`](../../doc/models/workspace-statistics.md).
...
result = taskrouter_v_1_workspace_statistics_api.fetch_workspace_statistics(
    workspace_sid,
    minutes=minutes,
