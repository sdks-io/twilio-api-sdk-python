...
```python
taskrouter_v_1_workflow_cumulative_statistics_api = client.taskrouter_v_1_workflow_cumulative_statistics
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`WorkflowCumulativeStatistics`](../../doc/models/workflow-cumulative-statistics.md).
...
result = taskrouter_v_1_workflow_cumulative_statistics_api.fetch_workflow_cumulative_statistics(
    workspace_sid,
    workflow_sid,
    end_date=end_date,
